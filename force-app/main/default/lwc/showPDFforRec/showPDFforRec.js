...
import showPDFforRec from '@salesforce/apex/PDFViewerController.showPDFforRec';




export default class ShowPDFforRec extends LightningElement {
    ...
    @wire(showPDFforRec, { recordId: '$recordId' })
